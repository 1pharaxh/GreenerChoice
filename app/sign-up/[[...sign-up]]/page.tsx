...
export default function Page() {
  return (
    <div className="container relative h-screen bg-white flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
      ...
      <div className="lg:p-8">
        <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
          <SignUp
            appearance={{
              elements: { formButtonPrimary: "bg-zinc-900 hover:bg-zinc-800" },
            }}
          />
        </div>
      </div>
